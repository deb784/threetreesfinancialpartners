...
(function () {
  ...
  /* ─── Contact Form ───────────────────────────────────────── */
  const contactForm   = document.getElementById('contact-form-netlify') || document.getElementById('contact-form');
  const successMsg    = document.getElementById('form-success');


if (contactForm) {
  const isNetlifyForm = contactForm.hasAttribute('data-netlify') || contactForm.querySelector('input[name="form-name"]') !== null;
